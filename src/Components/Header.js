      ...
      <div className="row justify-content-between align-items-center">
        <div className="col-lg-2 col-md-4">
          <div className="header-top-socials text-center text-lg-left text-md-left">
            ...
            <a href="https://www.linkedin.com/company/one2oneresearchsolutions" aria-label="linkedin"><i className="fab fa-linkedin"></i></a>
        ...
        <div className="col-lg-10 col-md-8 text-center text-lg-right text-md-right">
          <div className="header-top-info mb-2 mb-md-0">
            ...
            <a href="mailto:rfq@12oneresearch.com"><i className="fas fa-envelope mr-2"></i><span>rfq@12oneresearch.com</span></a>
          </div>
        </div>
      </div>
    </div>
          ...
          <nav className="navbar navbar-expand-lg px-0 py-4">
            ...
            <div className="collapse navbar-collapse text-center" id="navbarsExample09">
              ...
              <div className="my-2 my-md-0 ml-lg-4 text-center">
                <a data-toggle="modal" data-target="#exampleModalCenter" href="#" className="btn btn-solid-border btn-round-full">Get a Quote</a>
              </div>
            </div>
          </nav>
        </div>
